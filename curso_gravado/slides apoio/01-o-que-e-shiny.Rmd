...
### Shiny é um conjunto de conceitos e ferramentas em linguagem R para a criação de páginas web que possuem um programa rodando por trás.

---
class:: middle, center

### Um aplicativo shiny vai ser uma página web, uma aplicação web e um código R.
