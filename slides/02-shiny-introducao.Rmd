...
1) Faça um shiny app para visualizar histogramas da base diamonds
...
2) Escolha uma das bases da pasta dados ou use uma base própria.
...
3) Faça um Shiny app para mostrar um gráfico de dispersão (pontos)
