...
1) Utilizando a base de crédito, faça um Shiny app que permite escolher o estado civil, tipo de moradia e/ou trabalho e mostra uma visualização representando a proporção de clientes "bons" e "ruins" da base.

2) Utilizando a base de criminalidade, faça um Shiny app que, dado um mês/ano escolhido pelo usuário, mostre uma tabela com o número de ocorrências de cada tipo que aconteceram naquele mês.
O nível territorial (Estado, região, município ou delegacia) também pode ser um filtro.

---
## Exercícios

3) Faça um shiny app para visualizarmos boxplots da base diamonds.
