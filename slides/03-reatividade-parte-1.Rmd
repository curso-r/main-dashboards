...
criam as visualizações que vamos mostrar na UI e as deixam reativas. Na grande maioria dos casos, teremos o par `visualizacaoOutput()` `renderVisualizacao()`. 
...
Essa estrutura importante para entendermos onde devemos importar os nossos dados.
