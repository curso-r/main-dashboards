...
Para orientarmos a posição dos elementos do dashboard em linhas ou colunas, a depender da orientação definida no metadado, utilizamos uma linha com vários hífens:
