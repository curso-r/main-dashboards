...
- O certificado será emitido mediante uma **entrega final**. A engrega final será uma composição de todos os exercícios. O prazo da entrega final será de 7 dias após o fim do curso.

- Todos os exercícios e a entrega final serão um shiny app funcionando.
...
- A gravação das aulas ficará disponível no Google Clasroom por 1 ano após o final do curso.
