...
1) Usando a base da CETESB, construa um shiny app que possua um filtro de
poluente que depende de um filtro de estação de monitoramento. Como output, faça uma série temporal com a média diária da concentração do poluente.
